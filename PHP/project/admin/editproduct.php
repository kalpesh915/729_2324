                                                ...
                                                <div id="collapseOne" class="collapse show" data-parent="#accordion">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="my-3">
                                                            ...
                                                            <input type="text" name="productbrandname" id="productbrandname" required class="form-control" value="<?= $productbrandname; ?>">
                                                        </div>
                                                        ...
                                                        <div class="my-3">
                                                            ...
                                                            <select name="productcategory" id="productcategory" required class="form-control">
                                                                ...
                                                                while ($row = $result->fetch_assoc()) {
                                                                    if ($row["categoryid"] == $productcategory) {
                                                        ...
                                                        <div class="my-3">
                                                            ...
                                                            <textarea name="productdescription" id="productdescription" required class="form-control" style="resize: none;"><?= $productdescription; ?></textarea>
                                                        </div>
                                                ...
                                                <div id="collapseTwo" class="collapse" data-parent="#accordion">
                                                    <div class="card-body">
                                                        <div class="my-3">
                                                            ...
                                                            <input type="text" name="productcolor" id="productcolor" required class="form-control" value="<?= $productcolor; ?>">
                                                        </div>

                                                        <div class="my-3">
                                                            <label for="productweight">Enter Product Weight</label>
                                                            <input type="text" name="productweight" id="productweight" required class="form-control" value="<?= $productweight; ?>">
                                                        </div>

                                                        <div class="my-3">
                                                            <label for="productsize">Enter Product Size</label>
                                                            <input type="text" name="productsize" id="productsize" required class="form-control" value="<?= $productsize; ?>">
                                                        </div>

                                                        <div class="my-3">
                                                            <label for="productpackaging">Enter Product Packaging</label>
                                                            <input type="text" name="productpackaging" id="productpackaging" required class="form-control" value="<?= $productpackaging; ?>">
                                                        </div>

                                                        <div class="my-3">
                                                            <label for="productmaterial">Enter Product Material</label>
                                                            <input type="text" name="productmaterial" id="productmaterial" required class="form-control" value="<?= $productmaterial; ?>">
                                                        </div>

                                                        <div class="my-3">
                                                            <label for="productshape">Enter Product Shape</label>
                                                            <input type="text" name="productshape" id="productshape" required class="form-control" value="<?= $productshape; ?>">
                                                        </div>

                                                        <div class="my-3">
                                                            <label for="productcountry">Enter Product country</label>
                                                            <input type="text" name="productcountry" id="productcountry" required class="form-control" value="<?= $productcountry; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div id="collapseThree" class="collapse" data-parent="#accordion">
                                                    <div class="card-body">
                                                        <div class="my-3">
                                                            ...
                                                            <input type="text" name="productmrp" id="productmrp" required class="form-control" value="<?= $productmrp; ?>">
                                                        </div>

                                                        <div class="my-3">
                                                            <label for="productdiscount">Enter Product Discount</label>
                                                            <input type="text" name="productdiscount" id="productdiscount" required class="form-control" value="<?= $productdiscount; ?>">
                                                        </div>
                                                        ...
                                                        <div class="my-3">
                                                            ...
                                                            resize: none;"><?= $returnpolicy; ?></textarea>
                                                        </div>

                                                        <div class="my-3">
                                                            <label for="warranty">Enter Product Warranty</label>
                                                            <input type="text" name="productwarranty" id="productwarranty" required class="form-control" value="<?= $productwarranty; ?>">
                                                        </div>
                                                ...
                                                <div id="collapseFour" class="collapse" data-parent="#accordion">
                                                    <div class="card-body">
                                                        <div class="my-3">
                                                            ...
                                                            <input type="file" name="mediafiles[]" id="mediafiles" class="form-control" multiple accept=".jpg, .jpeg, .png, .svg, .mp4">
                                                        </div>
                                                        <div class="row">
                                                            <?php
                                                            $mediaresult = $product->getProductMedia($productid);

                                                            while ($mediarow = $mediaresult->fetch_assoc()) {
                                                                if($mediarow["mediatype"] == 1){
                                                                    echo "<div class='col-md-4 my-2'>
                                                                    <video class='mw-100' controls muted> <source src='$mediarow[mediapath]' type='video/mp4'></video>
