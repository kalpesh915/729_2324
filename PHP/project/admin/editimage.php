...
$result = $images->getSingleImage($imageid);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Images</h1>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        <img src="<?= $imagepath; ?>" class="h-50 w-75">
                                    </div>
                                    <div id="serviceForm">
                                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])."?imageid=$imageid"; ?>" method="post" enctype="multipart/form-data">
                                            <div class="my-3">
                                                <label for="imagetitle">Enter Image Title</label>
                                                <input type="text" name="imagetitle" id="imagetitle" class="form-control" required value="<?= $imagetitle; ?>">
                                            </div>
                                            <div class="my-3">
                                                <label for="imagedescription">Enter Image Description</label>
                                                <input type="text" name="imagedescription" id="imagedescription" class="form-control" required value="<?= $imagedescription; ?>">
                                            </div>
                                            <div class="my-3">
                                            ...
                                            <div class="my-3">
                                                <input type="submit" value="Update Image" name="updateProcess" class="btn btn-primary">
                                    ...
                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])."?delete=1&imageid=$imageid";?>" method="post" id="deleteForm">
...
<?php
    if(isset($_POST["updateProcess"])){
        ...
        if($file1["name"] !== ""){
            ...
            $images->updateImage($imageid, $imagetitle, $imagedescription, null, $imagetype);
        }
 
        $_SESSION["msg"] = "<div class='alert alert-success alert-dismissible fade show' role='alert'> <strong>Success : </strong> $destinations Image Updated on Server.
    ...
    if(isset($_GET["delete"])){
        ...
        $_SESSION["msg"] = "<div class='alert alert-success alert-dismissible fade show' role='alert'> <strong>Success : </strong>  Image Deleted From Server.
        <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
        <span aria-hidden='true'>&times;</span></button></div>";
