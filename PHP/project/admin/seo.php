            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Update SEO Details</h1>
...
<?php
    if(isset($_POST["updateProcess"])){
        ...
        $seo->logWriter($email, "Meta Details Updated to : $metakeywords, $metadescription, $googletagid");

        $_SESSION["msg"] = "<div class='alert alert-success alert-dismissible fade show' role='alert'><strong>Success : </strong>  Meta Tags Updated
