                                ...
                                <div class="card-body">
                                    ...
                                    <div id="faqForm">
                                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])."?faqid=$faqid"; ?>" method="post">
                                            ...
                                            <div class="my-3">
                                                <input type="submit" value="Update Faq" name="updateProcess" class="btn btn-primary">
                                                <input type="reset" value="Reset" class="btn btn-danger">
                                            </div>
                                        </form>
                                    </div>
                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])."?faqid=$faqid&delete=1"; ?>" method="post" id="deleteform">
                                        <button class="btn btn-danger" onclick="confirmDelete()" type="button">Delete This FAQ</button>
                                    </form >
                                    <hr>
...
<?php
    if(isset($_POST["updateProcess"])){
        ...
        $faq->logWriter($email, "$question FAQ Updated");
