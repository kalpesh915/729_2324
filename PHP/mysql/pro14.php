            ...
            try {
                ...
                if ($connection->connect_error) {
                    ...
                    */ 
                    ...
                    //$sqlquery = "select * from students where roll > 50";
                    //$sqlquery = "select * from students where fname = 'udit'";
                    //$sqlquery = "select * from students where not fname = 'udit'";
                    //$sqlquery = "select * from students where not fname = 'udit' or 1 = 1";
                    $sqlquery = "select * from students where roll = 5";
